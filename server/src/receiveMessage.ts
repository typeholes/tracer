...
//       case 'childrenById': {
//         const response: SpecificMessage<'childrenById'> = { ...parsed.data, children: getChildrenById(parsed.data.id) }
//         sendResponse(ws, id, response)
//         break
//       }

//       case 'typesById': {
//         const response: SpecificMessage<'typesById'> = { ...parsed.data, types: getTypesById(parsed.data.id) }
//         sendResponse(ws, id, response)
//         break
//       }

//       case 'typesByTypeId': {
//         const response: SpecificMessage<'typesByTypeId'> = { ...parsed.data, types: getTypesByTypeId(parsed.data.id) }
